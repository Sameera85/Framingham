...
def plot_gender_distribution():
    sns.countplot(data=df, x='male', ax=ax2)
...
ax2 = sns.countplot(x='male', hue='TenYearCHD', data=df, palette='Paired')
...
fig1 = px.box(df, x='age_groups', y='sysBP', color='male', title='Sys. BP vs Age Group by Gender')
fig1.update_xaxes(categoryorder='array', categoryarray=age_group_labels)

# Boxen plots for Dia. BP by Age Group & Gender
fig2 = px.box(df, x='age_groups', y='diaBP', color='male', title='Dia. BP vs Age Group by Gender')
fig2.update_xaxes(categoryorder='array', categoryarray=age_group_labels)

# Box plots for Sys. BP by Age Group & Gender
fig3 = px.box(df, x='age_groups', y='glucose', color='male', title='Glucose vs Age Group by Gender')
fig3.update_xaxes(categoryorder='array', categoryarray=age_group_labels)

# Boxen plots for Dia. BP by Age Group & Gender
fig4 = px.box(df, x='age_groups', y='totChol', color='male', title='Total Cholesterol vs Age Group by Gender')
